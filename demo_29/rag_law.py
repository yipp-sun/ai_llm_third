...
# ================== 配置区 ==================
class Config:
    EMBED_MODEL_PATH = r"D:/Workspace/llm/model/sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2"
    LLM_MODEL_PATH = r"D:/Workspace/llm/model/Qwen/Qwen1___5-1___8B-Chat"
...
def init_vector_store(nodes: List[TextNode]) -> VectorStoreIndex:
    ...
    if chroma_collection.count() == 0 and nodes is not None:
        ...
        # print(index._embed_model.model_name)
        # 双重持久化保障
